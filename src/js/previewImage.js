...
if (typeof Array.prototype.forEach != 'function') {
    ...
    var _previewImage = function(){
        ...
        this.imageChageNeedX = Math.floor(this.winw*(0.1)); //图片切换所需x位移量
        ...
        document.body.appendChild(this.$container);     //插入容器到body            //插入样式到head
        this.bind();    //绑定事件
    }
    ...
    _previewImage.prototype.translateScale = function (index,duration){
        ...
        var transition = 'transform '+duration+'s';
        this.addCssPrefix($elem,'transition',transition);
        this.addCssPrefix($elem,'transform',tran_2d);
        this.addCssPrefix($elem,'-webkit-transition',transition);
        this.addCssPrefix($elem,'-webkit-transform',tran_2d);
    }
