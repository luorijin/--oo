(function() {
    ...
    proto.getColumnNum = function() {
        ...
        this._viewPortWidth =this._container.offsetWidth;
        this._unitWidth=Math.floor((this._viewPortWidth+this.opts.gapWidth)/this.opts.col);
        this.opts.pinWidth= this._unitWidth - this.opts.gapWidth;

        //this._viewPortHeight = window.innerHeight || document.documentElement.clientHeight;
        this._viewPortHeight = this._container.offsetHeight;

        this._num = this.opts.col;
    ...
    proto.append = function(html, selector) {
        ...
        for (var j = 0, len = children.length; j < len; j++) {
            children[j].style.width=this.opts.pinWidth+"px";
    ...
    proto.bindScrollEvent = function() {
        addEvent(this._container.parentNode, "scroll", this.handleScroll.bind(this));
    };
    ...
    proto.checkScroll = function() {
        if (this.getMin() - this._container.parentNode.scrollTop < this._viewPortHeight + this.opts.threshold) {
            return true
        }
        return false;
    };
